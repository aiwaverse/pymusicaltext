...
class Note():
    ...
    def play(self, volume: int) -> List[Message]:
        """
        ...
        return [Message("note_on", note=self.__note, velocity=volume-1, time=60),Message("note_off", note=self.__note, velocity=volume, time=0)]
